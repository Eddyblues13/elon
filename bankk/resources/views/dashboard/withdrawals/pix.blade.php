...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Pix Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('pix.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Pix Key</label>
                                            <input id="pix_key" type="text" name="pix_key" class="form-control"
                                                placeholder="Enter your Pix Key" required>
                                        </div>
                                        <input type="hidden" id="routing" value="pix">
