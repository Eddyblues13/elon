                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 order-2 order-lg-1">
                        <div class="contact-form-content pt-sm-55 pt-xs-55">
                            <h3 class="contact-page-title">Customer Registration</h3>
                            <div class="contact-form">
                                <form id="register-form" action="{{ route('customer.register') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="li-btn-3" name="submit">Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
