...
<div class="main-panel">
    <div class="content bg-light">
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('admin.appliances.index') }}" class="btn btn-warning btn-lg"><i
            ...
            <div class="mb-5">
                <div class="text-right mb-4">
                    <a href="{{ route('admin.appliances.categories.create') }}" class="btn btn-primary"><i
                    ...
                    <table class="table table-striped table-bordered bg-light shadow">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Delete Button -->
                                    <form action="{{ route('admin.appliances.categories.destroy', $category->id) }}"
