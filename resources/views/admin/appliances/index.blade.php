...
<div class="main-panel">
    <div class="content bg-light">
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('admin.view.appliances') }}" class="btn btn-primary btn-lg"
                        style="margin:10px;">View
                        appliances</a>
                    <a href="{{ route('admin.appliances.categories.index') }}"
                        class="btn btn-warning btn-lg">appliances</a>

                    <a href="{{ route('admin.appliances.create') }}" class="float-right btn btn-primary"> <i
                            class='fas fa-plus-circle'></i>Create A New Appliance</a>
                </div>
            </div>
            <div class="mb-5 row">

                <div class="col-md-12 shadow applianced p-4 bg-light">
                    <div class="row">
                        <div class="col-12">
