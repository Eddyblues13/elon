...
<div class="main-panel">
    <div class="content bg-light">
        <div class="page-inner">
            ...
            @endif
            <div class="mt-2 mb-4">
                <h1 class="title1 text-dark">Products</h1>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('admin.view.cars') }}" class="btn btn-primary btn-lg" style="margin:10px;">View
                        Cars</a>
                    <a href="{{ route('admin.cars.categories.index') }}" class="btn btn-warning btn-lg">Cars</a>

                    <a href="{{ route('admin.cars.create') }}" class="float-right btn btn-primary"> <i
                            class='fas fa-plus-circle'></i>Create A New Car</a>
                </div>
            </div>
            <div class="mb-5 row">
