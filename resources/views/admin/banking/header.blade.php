...
<head>
    ...
    <title>Honest Hive Trust Bank | User Dashboard</title>
                ...
                <div class="sidebar-wrapper scrollbar scrollbar-inner">
                    <div class="sidebar-content">
                        ...
                        <ul class="nav nav-primary">
                            ...
                            <li class="nav-item ">
                                <a href="{{route('bank.manage.transactions.page')}}">
                            ...
                            <li class="nav-item">
                                <a href="{{route('bank.admin.deposit.index')}}">
                            ...
                            <li class="nav-item">
                                <a href="{{route('bank.admin.kyc.index')}}">
