        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="shop-top-bar mt-30">
                    <div class="shop-bar-inner">
                        ...
                        <div class="toolbar-amount">
                            <span>Showing {{ $appliances->firstItem() }} to {{ $appliances->lastItem() }} of {{
                                $appliances->total() }}
                                cars</span>
                        </div>
                    </div>
                    ...
                    <div class="product-select-box">
                        <div class="product-short">
                            <p>Sort By:</p>
                            <form method="GET" action="{{ route('shop.appliances.appliances') }}">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mt-40">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="{{route('shop.cars.show', $appliance->id) }}">
                                        <img src="{{ asset($appliance->image) }}" alt="{{ $appliance->name }}">
                                    </a>
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4><a class="product_name"
                                                href="{{ route('shop.cars.show', $appliance->id) }}">{{
                                                $appliance->description
                                                }}</a></h4>
                                        <div class="price-box">
                                            <p>Model: {{ $appliance->model }} | Year: {{ $appliance->year }}</p>
                                            <span class="new-price">${{ number_format($appliance->price, 2) }}</span>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="add-actions-link">
                                            <li class="add-cart active">
                                                <a href="javascript:void(0);"
                                                    onclick="addToCart({{ $appliance->id }}, 'car')">Add to cart</a>
                                            </li>
                ...
                <div class="pagination mt-4">
                    {{ $appliances->appends(request()->query())->links() }}
                </div>
                <!-- shop-top-bar end -->
