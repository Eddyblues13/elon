            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="{{ asset($appliance->image) }}"
                                data-gall="myGallery">
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h2>{{ $appliance->category->name ?? 'N/A' }}</h2>
                        <span class="product-details-ref">Category: {{ $appliance->name }}</span>
                        ...
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">${{ number_format($appliance->price, 2) }}</span>
                        </div>
                        ...
                        <div class="single-add-to-cart">
                            <form action="#" class="cart-quantity">
                                ...
                                <a href="javascript:void(0);" class="add-to-cart"
                                    onclick="addToCart({{ $appliance->id }})">Add to
                                    cart</a>
                            </form>
                        </div>
        ...
        <div class="tab-content">
            ...
            <div id="product-details" class="tab-pane" role="tabpanel">
                <div class="product-details-manufacturer">
                    <p><strong>Category:</strong> {{ $appliance->category->name ?? 'N/A' }}</p>
