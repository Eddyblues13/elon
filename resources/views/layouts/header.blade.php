                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="logo pb-sm-30 pb-xs-30">
                                <a href="index.html">
                                    <img src="images/menu/logo/1.png" alt="" style="width: 100px; height: auto;">
                                ...
                                <ul class="hm-menu">
                                    ...
                                    <li class="hm-minicart">
                                        <div class="hm-minicart-trigger">
                                            ...
                                            <span class="item-text">$<span class="cart-total-amount">{{
                                                    number_format(Session::get('cart_total', 0), 2) }}</span>
                                                <span class="cart-item-count">{{ count(Session::get('cart', []))
                                                    }}</span>
                                            </span>
                                        </div>
                                        <div class="minicart">
                                            <ul class="minicart-product-list">
                                                ...
                                                <li data-cart-key="{{ $key }}">
                                                    ...
                                                    <button class="close" title="Remove"
                                                        onclick="removeFromCart('{{ $key }}', '{{ $item['type'] ?? 'unknown' }}')">
                                                ...
                                                <li>
                                                    <a href="single-product.html" class="minicart-product-image">
                                                        <img src="{{ asset($item['image']) }}" alt="cart product">
                                                    </a>
                                                    <div class="minicart-product-details">
                                            ...
                                            <p class="minicart-total">SUBTOTAL: <span>${{
                                                    number_format(Session::get('cart_total', 0), 2) }}</span></p>
                            ...
                            <div class="hb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="/shop/trucks">Trucks</a></li>
