							...
							<div class="col-sm-12 col-12">
								<div class="d-flex justify-content-between my-4">
									...
									<div>
										...
										<p class="m-0">{{ \Carbon\Carbon::parse($invoice->created_at)->format('D, M j, Y
											g:i A') }}</p>
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>
													<h6>{{ \Carbon\Carbon::parse($invoice->created_at)->format('D, M j,
														Y g:i A') }}</h6>
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													...
													<h5 class="mt-4 text-blue">{{number_format($invoice->amount, 2, '.',
														',')}}</h5>
												</td>
											</tr>
