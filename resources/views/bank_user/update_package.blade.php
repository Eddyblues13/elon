			...
			<div class="col-xl-12">
				<div class="card" style="border-top-left-radius:30px; border-top-right-radius: 30px; ">
					<div class="card-body">
						...
						<a id="send_pin" href="{{route('bank_user.all.packages')}}" onclick='send(this)'
					...
					<div class="col-xl-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<form id="inter_form" action="{{ route('bank_user.update.shipment',$package->id)}}"
									method="POST">
									@csrf
									<div class="row mb-4">
			...
			<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
				<div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
					<div class="toast-header">
						<img src="https://honesthivetb.com/swift.png" alt="" class="me-2" height="18">
