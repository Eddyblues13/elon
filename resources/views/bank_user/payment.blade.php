                        ...
                        <div class='col-sm-6'>
                            ...
                            <div class='mt-4'>
                                <div>
                                    ...
                                    <input class='form-control ' value="sdbcnxcjnxxcjkjzsjbzxjzxjkjkzxj" id="myInput1"
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <form class='form-horizontal' action="{{ route('bank_user.make.payment')}}" method='POST'
                                ...
                                <div class='mt-4'>
                                    <div>
                                        ...
                                        <input class='form-control form-control-lg' id='imgInp' accept='image'
                                            name='image' onchange='return fileValidation()' type='file'>
                                    </div>
                                </div>
                            </div>
