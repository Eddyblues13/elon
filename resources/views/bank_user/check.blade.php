    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p>Please provide the necessary details below to upload your check. Ensure both the front and back sides
                    of the check are clear and readable.</p>

                <!-- Check Upload Form -->
                <form action="{{ route('bank_user.upload.check') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="check_description" name="check_description" rows="3"
                            placeholder="Provide a brief description or any important information about this check..."
                            required></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="check_front" name="check_front" accept="image/*"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="check_back" name="check_back" accept="image/*"
                            required>
