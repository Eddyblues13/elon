...
<head>
    ...
    <meta name="author" content="Honest Hive Trust Bank">
    <meta name="robots" content="noindex, nofollow">

    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Honest Hive Trust Bank : ">
    <meta property="og:title" content="Honest Hive Trust Bank : ">
    <meta property="og:description" content="Honest Hive Trust Bank : ">
    <meta property="og:image" content="admin71.Linit Wavetb.com/images/favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>Honest Hive Trust Bank - Dashboard</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png">
    <link href="{{asset('bank/vendor/jqvmap/css/jqvmap.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('bank/vendor/chartist/css/chartist.min.css')}}">
    <link href="{{asset('bank/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <link href="{{asset('bank/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
    <link href="{{asset('bank/css/style.css')}}" rel="stylesheet">

    <link href="{{asset('bank/vendor/libs/fontawesome-icons.css')}}" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('bank_user.dashboard')}}" class="brand-logo">

                <img style="height: 60px;" src="{{asset('bank/asset/img/logo.png')}}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info">
                                        <span class="text-black">Hello,
                                            <strong>{{Auth::guard('bank_user')->user()->first_name}}
                                                {{Auth::guard('bank_user')->user()->last_name}}</strong></span>
                                    </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{route('bank_user.profile')}}" class="dropdown-item ai-icon">
                                    ...
                                    <a href="{{route('bank_user.transactions')}}" class="dropdown-item ai-icon">
                                    ...
                                    <a href="{{route('bank_user.logOut')}}" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{{route('bank_user.dashboard')}}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('bank_user.crypto')}}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('bank_user.paypal')}}" aria-expanded="false">
                            <i class="fa fa-paypal"></i>
                            <span class="nav-text">Paypal Withdrawal</span>
                        </a>

                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route('bank_user.skrill')}}" aria-expanded="false">
                            <i class="fa fa-spinner"></i>
                            <span class="nav-text">Skrill Withdrawal</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route('bank_user.check.page')}}" aria-expanded="false">
                            <i class="fa fa-spinner"></i>
                            <span class="nav-text">Check Deposit</span>
                        </a>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="{{route('bank_user.card')}}" aria-expanded="false">
                            <i class="fa fa-credit-card"></i>
                            <span class="nav-text">Virtual Cards</span>
                        </a>

                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route('bank_user.loan')}}" aria-expanded="false">
                            <i class="fa fa-pie-chart"></i>
                            <span class="nav-text">Loans</span>
                        </a>

                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route('bank_user.logOut')}}" aria-expanded="false">
