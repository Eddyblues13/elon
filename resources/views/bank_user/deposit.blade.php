                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-12 mb-3 col-xxl-12 col-sm-12">
                                        <a class="btn btn-outline-primary rounded d-block btn-lg" data-bs-toggle="modal"
                                            data-bs-target="#fiat">+Fiat Deposit</a>
                                        <div class="modal fade" id="fiat">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Fiat Deposit</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="alert alert-info">
                                                            <p>To make fiat deposits please contact us via email or live
                                                                support as monetary policies and regulations may vary
                                                                with different geographic locations.</p>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-xxl-6 col-sm-6">
                        <div class="card bg-success">
                            <div class="card-body p-3">
                                <a href="{{route('bank_user.transactions')}}">
                                    <div class="d-flex align-items-center">
                                        <span class="bg-white rounded-circle p-3 me-4">
                                            <svg width="28" height="28" viewbox="0 0 28 28" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
