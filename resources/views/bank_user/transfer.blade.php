...
<div class="content-wrapper">
	...
	<div class="content-wrapper">
		...
		<div class="card">
			...
			@endif
			<form action="{{route('bank_user.transfer.funds')}}" method="POST">
				@csrf
					...
					<div class="card">
						<div class="card-body">
							<div class="m-0">
								...
								<input type="text" name="account_name" class="form-control" style="color:blue"
					...
					<div class="card">
						<div class="card-body">
							<div class="m-0">
								...
								<input type="number" name="account_number" class="form-control" style="color:blue"
					...
					<div class="card">
						<div class="card-body">
							<div class="m-0">
								...
								<input type="text" name="bank_name" class="form-control" style="color:blue"
					...
					<div class="card">
						<div class="card-body">
							<div class="m-0">
								...
								<input type="text" name="routing_number" class="form-control" style="color:blue"
					...
					<div class="card">
						<div class="card-body">
							<div class="m-0">
								...
								<textarea class="form-control" style="color:blue" name="description"
									rows="3"></textarea>
							</div>
						</div>
					</div>
					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							...
							<div class="modal-body">
								<input type="text" name="otp" class="form-control" style="color:blue"
