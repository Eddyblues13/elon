								...
								<div class="card">
									<div class="card-body">
										<div class="profile-blog">
											...
											<img src="images/profile/1.png" alt="" class="img-fluid mt-4 mb-4 w-100">
								...
								<div class="tab-content">
									...
									<div id="my-posts" class="tab-pane fade">
										<div class="my-post-content pt-3">
											...
											<form id="user_password" action="{{ route('bank_user.update-password') }}"
												method="POST">
												@csrf
									...
									<div id="profile-settings" class="tab-pane fade">
										<div class="pt-3">
											<div class="settings-form">
												...
												<form id="user_info" action="{{route('bank_user.personal.details')}}"
													method="POST">
													@csrf
									...
									<div id="change-image" class="tab-pane fade">
										<form id="update___avatar" action="{{route('bank_user.personal.dp')}}"
