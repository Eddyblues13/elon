                ...
                <div class="shop-top-bar mt-30">
                    <div class="shop-bar-inner">
                        ...
                        <div class="toolbar-amount">
                            <span>Showing {{ $cars->firstItem() }} to {{ $cars->lastItem() }} of {{ $cars->total() }}
                                cars</span>
                        </div>
                    </div>
                    ...
                    <div class="product-select-box">
                        <div class="product-short">
                            <p>Sort By:</p>
                            <form method="GET" action="{{ route('shop.cars.cars') }}">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mt-40">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="{{route('shop.cars.show', $car->id) }}">
                                    ...
                                    <div class="product_desc_info">
                                        <div class="product-review">
                                            <h5 class="manufacturer">
                                                <a href="{{ route('shop.cars.show', $car->id) }}">{{ $car->name }}</a>
                                            </h5>
                                        ...
                                        <h4><a class="product_name" href="{{ route('shop.cars.show', $car->id) }}">{{
                                                $car->description
                                                }}</a></h4>
                                        <div class="price-box">
                                            <p>Model: {{ $car->model }} | Year: {{ $car->year }}</p>
                                            <span class="new-price">${{ number_format($car->price, 2) }}</span>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="add-actions-link">
                                            <li class="add-cart active">
                                                <a href="javascript:void(0);"
                                                    onclick="addToCart({{ $car->id }}, 'car')">Add to cart</a>
                                            </li>
