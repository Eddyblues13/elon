            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="{{ asset($car->image) }}"
                                data-gall="myGallery">
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h2>{{ $car->category->name ?? 'N/A' }}</h2>
                        <span class="product-details-ref">Category: {{ $car->name }}</span>
                        ...
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">${{ number_format($car->price, 2) }}</span>
                        </div>
                        ...
                        <div class="single-add-to-cart">
                            <form action="#" class="cart-quantity">
                                ...
                                <a href="javascript:void(0);" class="add-to-cart"
                                    onclick="addToCart({{ $car->id }})">Add to
                                    cart</a>
                            </form>
                        </div>
