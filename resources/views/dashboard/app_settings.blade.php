...
<div class="main-panel bg-dark">
                            ...
                            <div class="card p-md-5 p-2 shadow-lg bg-dark">
                                ...
                                <div class="tab-content">
									<div class="tab-pane fade show active" id="info">
										<div class="row">
    <div class="col-12">
        <form method="post" action="https://lockestocks.com/account/admin/dashboard/updatewebinfo" id="appinfoform" enctype="multipart/form-data">
            <input type="hidden" name="_method" value="PUT">            <input type="hidden" name="_token" value="s195WfZZZJb3SUAWuuGNZ9Eo2OT4S0jZ1ogZrdon">            <div class=" form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="site_title" class="form-control bg-dark text-light" value="locke stockssss" required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Website Keywords</h5>
                    <input type="text" name="keywords" class="form-control bg-dark text-light" value="lockestocks, locke stocks," required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Website Url (https://yoursite.com)</h5>
                    <input type="text" placeholder="https://yoursite.com" name="site_address" class="form-control bg-dark text-light" value="https://lockestocks.com/account" required>
                </div>
                <div class="form-group col-md-12">
                    <h5 class="text-light">Website Description</h5>
                    <textarea name="description" class="form-control bg-dark text-light" rows="4">Expert trades</textarea>
                </div> 
            </div>
            ...
            <div class=" form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="update" class="form-control bg-dark text-light" rows="2">Welcome to Trader system</textarea>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Live chat widget Code</h5>
                    <textarea name="tawk_to" class="form-control bg-dark text-light" rows="4">tawk to codess</textarea>
                </div>
                <div class="form-group col-md-6">
    ...
    <div class="col-12">
        <form method="post" action="javascript:void(0)" id="updatepreference">
            <input type="hidden" name="_token" value="s195WfZZZJb3SUAWuuGNZ9Eo2OT4S0jZ1ogZrdon">            <input type="hidden" name="_method" value="PUT">            <div class="form-row">
                <div class="form-group col-md-6">
                    <h5 class="text-light">Contact Email</h5>
                    <input type="text" class="form-control bg-dark text-light" name="contact_email" value="support@lockestocks.com" required>
                </div>
                <div class="form-group col-md-6">
                ...
                <input name="s_currency" value="ZAR" id="s_c" type="hidden">
                <div class="form-group col-md-6">
                ...
                <input type="hidden" value="" name="site_preference">
            </div>
        ...
        <form action="javascript:void(0)" method="POST" id="emailform">
            <input type="hidden" name="_token" value="s195WfZZZJb3SUAWuuGNZ9Eo2OT4S0jZ1ogZrdon">            <input type="hidden" name="_method" value="PUT">            <div class=" form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="email" name="emailfrom" class="form-control bg-dark text-light" value="support@lockestocks.com" required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Email From Name</h5>
                    <input type="text" name="emailfromname" class="form-control bg-dark text-light" value="lockestocks Market" required>
                </div>
                <div class="form-group col-md-6 smtp d-none">
                    <h5 class="text-light">SMTP Host</h5>
                    <input type="text" name="smtp_host" class="form-control bg-dark text-light smtpinput" value="lockestocks.com">
                </div>
                <div class="form-group col-md-6 smtp d-none">
                    <h5 class="text-light">SMPT Port</h5>
                    <input type="text" name="smtp_port" class="form-control bg-dark text-light smtpinput" value="465">
                </div>
                <div class="form-group col-md-6 smtp d-none">
                    <h5 class="text-light">SMPT Encryption</h5>
                    <input type="text" name="smtp_encrypt" class="form-control bg-dark text-light smtpinput" value="ssl">
                </div>
                <div class="form-group col-md-6 smtp d-none">
                    <h5 class="text-light">SMPT Username</h5>
                    <input type="text" name="smtp_user" class="form-control bg-dark text-light smtpinput" value="support@lockestocks.com">
                </div>
                <div class="form-group col-md-6 smtp d-none">
                    <h5 class="text-light">SMPT Password</h5>
                    <input type="text" name="smtp_password" class="form-control bg-dark text-light smtpinput" value="Update2022@">
                </div>
            </div>
            <hr>
            <div class="form-row">
            ...
            <div class=" form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="google_id" class="form-control bg-dark text-light" value="807575122053-0056a75lgfai5f205sc0fvku6tqgd6ac.apps.googleusercontent.com">
                    <small class="text-light"> From console.cloud.google.com</small>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Client Secret</h5>
                    <input type="text" name="google_secret" class="form-control bg-dark text-light" value="OTUW0i4B7ZI-GaoNPwe1krPF">
                    <small class="text-light"> From console.cloud.google.com</small>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Redirect URL</h5>
                    <input type="text" name="google_redirect" class="form-control bg-dark text-light" value="http://yoursite.com/auth/google/callback">
            ...
            <div class=" form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="capt_secret" class="form-control bg-dark text-light" value="6LeFiYEaAAAAAPWZh1eQgdd5W99qz8KXZEEmCFaK">
                    <small class="text-light"> From https://www.google.com/recaptcha/admin/create  </small>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-light">Captcha Site-Key</h5>
                    <input type="text" name="capt_sitekey" class="form-control bg-dark text-light" value="6LeFiYEaAAAAAHmnxl4z7s9IH1-TmmCu1mD9Mn_8">
                    <small class="text-light"> From https://www.google.com/recaptcha/admin/create</small>
                </div>
                <div class="form-group col-md-12">
                    <input type="submit" class="px-5 btn btn-primary btn-lg" value="Save">
