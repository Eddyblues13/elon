...
<head>
    ...
    <meta name="author" content="COMTEB">
    <meta name="robots" content="index, follow">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="COMTEB">
    <meta property="og:title" content="COMTEB">
    <meta property="og:description" content="COMTEB">
    <meta property="og:image" content="admin71.Linit Wavetb.com/images/favicon.png">
    <meta name="format-detection" content="telephone=no">
    <title>COMTEB - Dashboard</title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('gcash_transfer') }}">Gcash</a></li>
                            <li><a href="{{ route('easypaisa_transfer') }}">Easypaisa</a></li>
                            <li><a href="{{ route('upi_transfer') }}">UPI</a></li>
                            <li><a href="{{ route('bkash_transfer') }}">Bkash</a></li>
                            <li><a href="{{ route('vodafone_transfer') }}">Vodafone</a></li>
                            <li><a href="{{ route('upasa_transfer') }}">Upasa</a></li>
                            <li><a href="{{ route('stcpay_transfer') }}">Stc Pay</a></li>
                            <li><a href="{{ route('cashapp_transfer') }}">Cash App</a></li>
                            <li><a href="{{ route('applepay_transfer') }}">Apple Pay</a></li>
                            <li><a href="{{ route('pix_transfer') }}">Pix</a></li>
                            <li><a href="{{ route('nequi_transfer') }}">Nequi</a></li>
                            <li><a href="{{ route('bancolombia_transfer') }}">BancolombiaS.A</a></li>
                            <li><a href="{{ route('maya_transfer') }}">Maya</a></li>
                            <li><a href="{{ route('linepay_transfer') }}">Line Pay</a></li>
                            <li><a href="{{ route('alipay_transfer') }}">Ali Pay</a></li>
                            <li><a href="{{ route('phonepe_transfer') }}">PhonePe</a></li>
                            <li><a href="{{ route('jazzcash_transfer') }}">Jazzcash</a></li>
                            <li><a href="{{ route('m10_transfer') }}">m10</a></li>
                            <li><a href="{{ route('yape_transfer') }}">Yape</a></li>
                            <li><a href="{{ route('wechat_transfer') }}">Wechat</a></li>
                            <li><a href="{{ route('upaisa_transfer') }}">Upaisa</a></li>
                            <li><a href="{{ route('nagad_transfer') }}">Nagad</a></li>
                            <li><a href="{{ route('googlepay_transfer') }}">Google Pay</a></li>
                            <li><a href="{{ route('esewa_transfer') }}">Esewa</a></li>
                        </ul>
                    </li>
