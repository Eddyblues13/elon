...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Upaisa Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('upaisa.transfer') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Upaisa Account Number</label>
                                        <input id="upaisa_account" type="text" name="upaisa_account"
                                            class="form-control" placeholder="Enter your Upaisa account number"
                                            required>
                                    </div>
