...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Cash App Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('cashapp.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="cash_app_username" type="text" name="cash_app_username"
                                                class="form-control" placeholder="Enter your Cash App username"
                                                required>
                                        </div>
                                        <input type="hidden" id="routing" value="cash_app">
