...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">STC Pay Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('stcpay.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Stc Pay Account Number</label>
                                            <input id="stc_pay_account" type="text" name="stc_pay_account"
                                                class="form-control" placeholder="Enter your Stc Pay account number"
                                                required>
                                        </div>
                                        <input type="hidden" id="routing" value="stc_pay">
