...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">UPI Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('upi.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>UPI ID</label>
                                            <input id="upi_id" type="text" name="upi_id" class="form-control"
                                                placeholder="Enter your UPI ID" required>
                                        </div>
                                        <input type="hidden" id="routing" value="upi">
