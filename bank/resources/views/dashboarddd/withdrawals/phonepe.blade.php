...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Phonepe Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('phonepe.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="phonepe_number" type="text" name="phonepe_number"
                                                class="form-control" placeholder="Enter your PhonePe number" required>
                                        </div>
                                        <input type="hidden" id="routing" value="phonepe">
