			...
			<tbody>
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<h2>Welcome to IET Market</h2>
						<br>
						<br>
						<p style='line-height: 24px;margin-bottom:15px;'>
							Thanks for joining IET Market as your new home. We're excited to have you
							on
							board!
						</p>
						<p style='line-height: 24px;margin-bottom:15px;'>
				...
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<center>
							<span style="color: #706d6b"> © 2024 IET Market</span>
						</center>
