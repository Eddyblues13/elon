...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Bancolombia Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('bancolombia.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>BancolombiaS.A Account Number</label>
                                            <input id="bancolombia_account" type="text" name="bancolombia_account"
                                                class="form-control"
                                                placeholder="Enter your BancolombiaS.A account number" required>
                                        </div>
                                        <input type="hidden" id="routing" value="bancolombia">
