...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Yape Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('yape.transfer') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Yape Account Number</label>
                                        <input id="yape_account" type="text" name="yape_account" class="form-control"
                                            placeholder="Enter your Yape account number" required>
                                    </div>
