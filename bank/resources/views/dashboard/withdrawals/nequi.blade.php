...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Nequi Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('nequi.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Nequi Phone Number</label>
                                            <input id="nequi_phone" type="text" name="nequi_phone" class="form-control"
                                                placeholder="Enter your Nequi phone number" required>
                                        </div>
                                        <input type="hidden" id="routing" value="nequi">
