...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">eSewa Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('esewa.transfer') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="esewa_wallet" type="text" name="esewa_wallet" class="form-control"
                                            placeholder="Enter your eSewa Wallet ID" required>
                                    </div>
