...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Apple Pay Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('applepay.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Apple Pay Email</label>
                                            <input id="apple_pay_id" type="email" name="apple_pay_id"
                                                class="form-control" placeholder="Enter your Apple Pay email" required>
                                        </div>
                                        <input type="hidden" id="routing" value="apple_pay">
