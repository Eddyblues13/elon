...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">WeChat Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('wechat.transfer') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <label>WeChat Account ID</label>
                                        <input id="wechat_account" type="text" name="wechat_account"
                                            class="form-control" placeholder="Enter your WeChat Account ID" required>
                                    </div>
