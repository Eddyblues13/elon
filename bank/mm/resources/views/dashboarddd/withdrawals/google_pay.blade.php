...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Google Pay Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('googlepay.transfer') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Google Pay UPI ID</label>
                                        <input id="google_pay_upi" type="text" name="google_pay_upi"
                                            class="form-control" placeholder="Enter your Google Pay UPI ID" required>
                                    </div>
