...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Bkash Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('bkash.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="bkash_phone" type="text" name="bkash_phone" class="form-control"
                                                placeholder="Enter your Bkash phone number" required>
                                        </div>
                                        <input type="hidden" id="routing" value="bkash">
