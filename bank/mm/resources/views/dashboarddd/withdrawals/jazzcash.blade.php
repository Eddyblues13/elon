...
<div class="content-body">
    ...
    <div class="container-fluid">
        <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Jazzcash Withdrawal</h2>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('jazzcash.transfer') }}" method="POST">
                                    @csrf
                                    <div id="content-one">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="phone_number" type="text" name="phone_number"
                                                class="form-control" placeholder="Enter your Jazzcash phone number"
                                                required>
                                        </div>
                                        <input type="hidden" id="routing" value="jazzcash">
